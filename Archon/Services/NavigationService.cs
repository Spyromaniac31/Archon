...
namespace Archon.Services
{
    public static class NavigationService
    {
        ...
        public static bool Navigate(Type pageType, object parameter = null, NavigationTransitionInfo infoOverride = null)
        {
            ...
            //The condition basically says, "If the current page is different than pageType or if a new parameter is being used"
        ...
        //This basically hooks the frame up to the NavigationService methods. This might be where the subscription happens, because it seems
        //it's setting the NavigationService methods to run when the frame's events are triggered.
